...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/libQt5QuickShapes.so.5.12.0"
    cpp.defines: ["QT_QUICKSHAPES_LIB"]
    cpp.includePaths: ["/usr/include/qt", "/usr/include/qt/QtQuickShapes", "/usr/include/qt/QtQuickShapes/5.12.0", "/usr/include/qt/QtQuickShapes/5.12.0/QtQuickShapes"]
    cpp.libraryPaths: []
    Group {
