...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/libQt5QuickParticles.so.5.12.0"
    cpp.defines: ["QT_QUICKPARTICLES_LIB"]
    cpp.includePaths: ["/usr/include/qt", "/usr/include/qt/QtQuickParticles", "/usr/include/qt/QtQuickParticles/5.12.0", "/usr/include/qt/QtQuickParticles/5.12.0/QtQuickParticles"]
    cpp.libraryPaths: []
    Group {
