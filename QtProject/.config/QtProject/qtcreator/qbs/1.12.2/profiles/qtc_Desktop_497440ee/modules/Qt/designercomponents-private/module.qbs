...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/libQt5DesignerComponents.so.5.12.0"
    cpp.defines: ["QT_DESIGNERCOMPONENTS_LIB"]
    cpp.includePaths: ["/usr/include/qt", "/usr/include/qt/QtDesignerComponents", "/usr/include/qt/QtDesignerComponents/5.12.0", "/usr/include/qt/QtDesignerComponents/5.12.0/QtDesignerComponents"]
    cpp.libraryPaths: []
    Group {
