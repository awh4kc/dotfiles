...
QtModule {
    ...
    libFilePathDebug: ""
    libFilePathRelease: "/usr/lib/libQt5EglFSDeviceIntegration.so.5.12.0"
    cpp.defines: ["QT_EGLFSDEVICEINTEGRATION_LIB"]
    cpp.includePaths: ["/usr/include/qt", "/usr/include/qt/QtEglFSDeviceIntegration", "/usr/include/qt/QtEglFSDeviceIntegration/5.12.0", "/usr/include/qt/QtEglFSDeviceIntegration/5.12.0/QtEglFSDeviceIntegration"]
    cpp.libraryPaths: []
    Group {
