...
Module {
    ...
    property path docPath: "/usr/share/doc/qt"
    ...
    property string libFilePathRelease: "/usr/lib/libQt5Core.so.5.12.0"
    ...
    cpp.includePaths: {
        var paths = ["/usr/include/qt", "/usr/include/qt/QtCore"];
