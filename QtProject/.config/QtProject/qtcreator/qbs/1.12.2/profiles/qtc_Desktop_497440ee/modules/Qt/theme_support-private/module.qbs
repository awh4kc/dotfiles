...
QtModule {
    ...
    hasLibrary: true
    staticLibsDebug: []
    staticLibsRelease: ["/usr/lib/libQt5DBus.so.5.12.0", "GL"]
    dynamicLibsDebug: []
    dynamicLibsRelease: []
    linkerFlagsDebug: []
    linkerFlagsRelease: []
    ...
    cpp.includePaths: ["/usr/include/qt", "/usr/include/qt/QtThemeSupport", "/usr/include/qt/QtThemeSupport/5.12.0", "/usr/include/qt/QtThemeSupport/5.12.0/QtThemeSupport"]
    cpp.libraryPaths: []
